...
def load_and_preprocess_data(train_csv: str, test_csv_1: str, test_csv_v2: str) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
    try:
        # Load data
        ...
        return X_train_tensor, y_train_tensor, X_test_1_tensor, y_test_1_tensor, X_test_v2_tensor, y_test_v2_tensor
...
if __name__ == "__main__":
    ...
    X_train_tensor, y_train_tensor, X_test_1_tensor, y_test_1_tensor, X_test_v2_tensor, y_test_v2_tensor = load_and_preprocess_data(csv_train, csv_test_1, csv_test_v2)

    # Initialize models
    input_size = 1024  # Set this to the dimension of your features
    num_classes = 1000
